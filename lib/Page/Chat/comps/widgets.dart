...
import 'package:mynotes/Page/Chat/comps/animated-dialog.dart';
import 'package:mynotes/Page/Chat/comps/styles.dart';
...
class ChatWidgets {
  ...
  static drawer(context) {
    return Drawer(
      backgroundColor: Color.fromRGBO(217, 96, 0, 1.0),
      child: SafeArea(
        child: Padding(
