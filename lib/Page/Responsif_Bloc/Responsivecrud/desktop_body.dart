...
class mycruddesktop extends StatefulWidget {
  const mycruddesktop({Key? key}) : super(key: key);

  @override
  State<mycruddesktop> createState() => _mycruddesktopState();
}

class _mycruddesktopState extends State<mycruddesktop> {
            ...
            if (streamSnapshot.hasData) {
              ...
              return GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 2,
                  childAspectRatio: 2, // rasio lebar-tinggi 2:1
                ),
                itemCount: streamSnapshot.data!.docs.length,
                itemBuilder: (context, index) {
                  final DocumentSnapshot documentSnapshot =
