...
class mycrudmobile extends StatefulWidget {
  const mycrudmobile({Key? key}) : super(key: key);

  @override
  State<mycrudmobile> createState() => _mycrudmobileState();
}

class _mycrudmobileState extends State<mycrudmobile> {
